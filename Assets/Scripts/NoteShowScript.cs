...
public class NoteShowScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            case 1:
                what = musician.GetComponent<Musician>().WhichNotes;
                break;
            case 2:
                what = musician.GetComponent<Musician>().SecondNoteInterval;
                break;
            case 3:
                what = musician.GetComponent<Musician>().WhichNotes;
                break;
            case 4:
                what = musician.GetComponent<Musician>().SecondNoteTriad;
                break;
            case 5:
                what = musician.GetComponent<Musician>().ThirdNoteTriad;
                break;
        }
